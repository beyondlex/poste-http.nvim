...
describe("log viewer _get_entry_at_line", function()
  ...
  it("returns entry 1 at line 3 (first data row)", function()
    assert.equals(1, log._get_entry_at_line(3))
  end)

  it("returns entry 2 at line 4", function()
    assert.equals(2, log._get_entry_at_line(4))
  end)

  it("returns entry 3 at line 5", function()
    assert.equals(3, log._get_entry_at_line(5))
  end)
  ...
  it("returns same entry when on detail lines (expanded)", function()
    ...
    assert.equals(1, log._get_entry_at_line(5))
